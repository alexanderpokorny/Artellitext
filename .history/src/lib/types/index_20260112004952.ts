...
export type SubscriptionTier = 'free' | 'pro' | 'team' | 'enterprise' | 'lifetime';
 ...
 * - dark: Dark mode
 * - high-contrast: Black text on white, maximum contrast (WCAG AAA, E-Ink)
 * - auto: Follow system preference
 */
export type Theme = 'light' | 'dark' | 'high-contrast' | 'auto';

/** Visual theme after resolving 'auto' */
